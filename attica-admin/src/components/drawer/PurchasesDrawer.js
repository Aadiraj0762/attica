...
const CreatePurchase = (id) => {
  ...
  //     try {
  //       const response = await axios.get('http://localhost:5055/api/category'); // Replace 'https://api.com/categories' with your API endpoint
  //       const data = response.data;
  //       // Extract parent and children categories with different icons
  //       const options = data.map(parentCategory => {
