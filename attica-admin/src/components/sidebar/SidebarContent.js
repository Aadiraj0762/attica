  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a  className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === "dark" ? (
          <img src={"https://res.cloudinary.com/djqex7eae/image/upload/v1705991643/sfvtd4uwhwrmmspgatxe.png"} alt="Attica" width="135" className="pl-6" />
        ) : (
          <img src={"https://res.cloudinary.com/djqex7eae/image/upload/v1705991643/sfvtd4uwhwrmmspgatxe.png"} alt="Attica" width="135" className="pl-6" />
        )}
      </a>
      ...
      <span className="lg:fixed bottom-0 px-6 py-6 w-64 mx-auto relative mt-3 block">
        <Button onClick={handleLogOut} size="large" className="w-full" id="styleButton">
