...
//         // Redirect to a different dashboard for Executive
//         // Set the dashboardRoute value accordingly
//         dashboardRoute = '/executive-dashboard';
//       } else {
//         const token = signInToken(admin);
//         dashboardRoute = '/admin-dashboard'; // Default route for Admin
//       }
...
//         email: admin.email,
//         image: admin.image,
//         dashboardRoute, // Include the dashboard route in the response
//       });
//     } else {
//       res.status(401).send({
//         message: "Invalid Email or password!",
